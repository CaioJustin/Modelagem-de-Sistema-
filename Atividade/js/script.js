...
setInterval(()=>{
    ...
    // converter 24 para 12h
    
    if (h >12){
        h=h-12;
    }
    
    //adicionar zero antes de um único numero
    ...
    //360 /12=30
    hr_ponto.style.transform = `rotate(${h*30})`

    //360 /60=6
    min_ponto.style.transform = `rotate(${m*30})`

    //360 /60=6
    seg_ponto.style.transform = `rotate(${s*30})`
